...
import com.rhg.qf.easeui.utils.EaseCommonUtils;
import com.rhg.qf.easeui.utils.EaseImageUtils;
...
public class EaseChatFragment extends BaseFragment implements EMEventListener {
    ...
    EaseVoiceRecorderView voiceRecorderView;// 按住说话录音控件
    ...
    protected void setListItemClickListener() {
        messageList.setItemClickListener(new EaseChatMessageList.MessageListItemClickListener() {
            ...
            public void onResendClick(final EMMessage message) {
                ...
                uiAlertView = new UIAlertView(getContext(), getString(R.string.resend), getString(R.string.confirm_resend),
                ...
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        if (listView.getFirstVisiblePosition() == 0 && !isloading && haveMoreData) {
                            ...
                            ToastHelper.getInstance().displayToastWithQuickClose(getResources().getString(R.string.no_more_messages));
                        }
                        swipeRefreshLayout.setRefreshing(false);
                    }
                }, 600);
        ...
        chatRoomChangeListener = new EMChatRoomChangeListener() {
            ...
            public void onChatRoomDestroyed(String roomId, String roomName) {
                if (roomId.equals(toChatUsername)) {
                    ToastHelper.getInstance().displayToastWithQuickClose(" room : " + roomId + " with room name : " + roomName + " was destroyed");
                    getActivity().finish();
                }
            }
            ...
            public void onMemberJoined(String roomId, String participant) {
                ToastHelper.getInstance().displayToastWithQuickClose("member : " + participant + " join the room : " + roomId);
            }

            @Override
            public void onMemberExited(String roomId, String roomName, String participant) {
                ToastHelper.getInstance().displayToastWithQuickClose("member : " + participant + " leave the room : " + roomId + " room name : " + roomName);
            }
            ...
            public void onMemberKicked(String roomId, String roomName, String participant) {
                if (roomId.equals(toChatUsername)) {
                    ...
                    if (curUser.equals(participant)) {
                        ...
                        ToastHelper.getInstance().displayToastWithQuickClose("member : " + participant + " was kicked from the room : " + roomId + " room name : " + roomName);
                    }
                }
            }
...
//                Log.i("RHG", "onProgress:" + s);
    ...
    protected void selectPicFromCamera() {
        if (!EaseCommonUtils.isExitsSdcard()) {
            ToastHelper.getInstance().displayToastWithQuickClose(getString(R.string.sd_card_does_not_exist));
            return;
        }
