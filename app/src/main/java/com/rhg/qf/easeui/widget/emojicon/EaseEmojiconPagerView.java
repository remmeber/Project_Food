package com.rhg.qf.easeui.widget.emojicon;
...
import com.rhg.qf.R;
import com.rhg.qf.easeui.adapter.EmojiconGridAdapter;
import com.rhg.qf.easeui.adapter.EmojiconPagerAdapter;
import com.rhg.qf.easeui.domain.EaseEmojicon;
import com.rhg.qf.easeui.domain.EaseEmojiconGroupEntity;
...
public class EaseEmojiconPagerView extends ViewPager {
    ...
    public List<View> getGroupGridViews(EaseEmojiconGroupEntity groupEntity) {
        ...
        for (int i = 0; i < pageSize; i++) {
            View view = LayoutInflater.from(context).inflate(R.layout.ease_expression_gridview, null);
//            View view = View.inflate(context, R.layout.grid_type_layout, null);
            MyGridView gv = (MyGridView) view.findViewById(R.id.express_gridview);
            if (emojiType == EaseEmojicon.Type.BIG_EXPRESSION) {
