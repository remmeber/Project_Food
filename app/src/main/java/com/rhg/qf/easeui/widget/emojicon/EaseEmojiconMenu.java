...
public class EaseEmojiconMenu extends EaseEmojiconMenuBase {
    ...
    private void init(Context context, AttributeSet attrs) {
        View view = LayoutInflater.from(context).inflate(R.layout.ease_widget_emojicon, this);
        ...
        pagerView = (EaseEmojiconPagerView) view.findViewById(R.id.pager_view);
        indicatorView = (EaseEmojiconIndicatorView) view.findViewById(R.id.indicator_view);
        tabBar = (EaseEmojiconScrollTabBar) view.findViewById(R.id.tab_bar);
    }
